...
export type PortugueseSearchVia = { word: string; kind: 'collocation'; src: string | null };

export type PortugueseCollocation = {
...
export class PortugueseDictService {
  ...
  search(query: string, limit = 20): PortugueseSearchItem[] {
    ...
    const items: PortugueseSearchItem[] = rows.map((r) => ({
