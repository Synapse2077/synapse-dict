#!/usr/bin/env python3
"""葡萄牙语数据路径 —— **本语种数据位置的唯一真相源**。2026-08-01。
...
DB      = DATA / "db" / "synapse-dict-pt.sqlite"                    # 成品库
KK      = DATA / "dumps" / "kaikki.org-dictionary-Portuguese.jsonl"                 # 英文版 per-language 切片（建库源）
EDITION = DATA / "dumps" / "ptwiktionary.jsonl.gz"        # 该语种自己的维基版整包（多语种，按 lang_code 筛）
WORK    = DATA / "work" / "pt"                  # 过程产物：runs / 冲突表 / 模型输出
