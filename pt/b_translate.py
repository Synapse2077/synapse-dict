...
葡语专属：豆包 IPA 兜底须**同时返回巴西(br)与葡萄牙(pt)两套音**；无 aux/government/adj_pos。
...
11. 返回 "level" 字段：该词的 CEFR 难度等级，取值 A1/A2/B1/B2/C1/C2 之一（A1 最基础常用、C2 最生僻高阶）；按该葡语词的实际使用频率与掌握难度判断，务必每词都给。
12. 严格输出 JSON，键与输入一致，格式 {"1":{"zh":[...],"gender":"m","plural":"...","feminine":"...","ipa_br":"/.../","ipa_pt":"/.../","col":["..."],"level":"B1","flag":null},...}（gender/plural/feminine/ipa_br/ipa_pt/col 无则省略，level 必给），不要多余文字。"""
