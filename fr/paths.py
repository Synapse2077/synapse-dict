#!/usr/bin/env python3
"""法语数据路径 —— **本语种数据位置的唯一真相源**。2026-08-01。
...
DB      = DATA / "db" / "synapse-dict-fr.sqlite"                    # 成品库
KK      = DATA / "dumps" / "kaikki.org-dictionary-French.jsonl"                 # 英文版 per-language 切片（建库源）
EDITION = DATA / "dumps" / "frwiktionary.jsonl.gz"        # 该语种自己的维基版整包（多语种，按 lang_code 筛）
WORK    = DATA / "work" / "fr"                  # 过程产物：runs / 冲突表 / 模型输出
